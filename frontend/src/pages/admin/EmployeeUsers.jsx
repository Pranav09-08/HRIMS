...
function AdminEmployeeUsersPage() {
  ...
  const fetchRows = async () => {
    try {
      const response = await fetch(`${API_BASE_URL}/api/admin/users?role=employee`, {
        headers: authHeaders,
      })
  ...
  return (
    <DashboardLayout role="admin" title="Admin Dashboard" subtitle="People: Employee">
      <div className="space-y-6">
        ...
        <div className="grid gap-6 xl:grid-cols-[0.95fr_1.05fr]">
          <section className="rounded-2xl border border-black/10 bg-[#fafafa] p-4">
            ...
            <p className="mt-1 text-sm text-black/55">Manage employee onboarding and account lifecycle from one panel.</p>
          ...
          <section className="rounded-2xl border border-black/10 bg-white p-4">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                <h3 className="text-lg font-semibold text-black">Employee Directory</h3>
...
export default AdminEmployeeUsersPage
